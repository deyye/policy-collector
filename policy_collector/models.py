...
class Classification:
    ...
    doc_type: str = "其他"
    need_review: bool = False              # 是否需人工介入（仅 scope/review 两类为真）
    todo_type: str = "none"                # none/material/scope/review/system，见 classification.yaml
    reason: str = ""                       # 判断理由
    ...
    def todo_name(self) -> str:
        return {"none": "", "material": "待补材料", "scope": "待定口径",
                "review": "待复核结论", "system": "待修故障"}.get(self.todo_type, "")
