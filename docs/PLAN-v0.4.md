...
> **历史规划稿，保留设计过程，不作为当前使用说明。**
> v0.4 已实现模型配置页、configure-llm/llm-check、qwen-plus 预置及福建/陕西/湖南来源扩展，并保留浙江全量翻页、江苏列表。
> 当前实现、验证与未完成事项以 [README](../README.md) 和 [v0.4 验证说明](VALIDATION-v0.4.md) 为准；模型真实效果评测仍暂缓。
